...
*** Egyptian linear algebra: Single and False Position
...
*** TODO Another Mesopotamian (non-linear) system
This from the Hammurabi dynasty as in cite:joseph2011
#+begin_quote
Length (/ush/), width (/sag/0. I have multiplied /ush/ and /sag/ thus obtaining the area (/asha/). Then I added to /asha/, the excess of the /ush/ over the /sag/: result 3,03. I have added /ush/ and /sag/: result 27. Required /ush/, /sag/, and /asha/.
#+end_quote
