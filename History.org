#+TITLE: Math History Notes for Math 531 Fall 2020
#+AUTHOR: John Hammond
...
*** Binary thinking
#+ATTR_REVEAL: :frag (appear)
- Leibniz invents binary number system - using 0's and 1's
  published in 1703 /Explication de l'Arithmétique Binaire/
- Has addition, subtraction, multiplication, and division
- Acknowledges the earlier work of Fuxi and the "mystery of lines"
  (Note: Fuxi is said to be the inventor of Chinese writing)

#+REVEAL: split
- Leibniz' binary system was philosophical - Laplace wrote (as in cite:Ifrah2000, pg 89):

  #+ATTR_REVEAL: :frag (appear)
  #+begin_quote
  In the binary system which he invented, Leibniz south to perceive the Creation. He imagined that the Unity stood for God and Zero for the Void, that the Supreme Being had drawn every existing thing out of the void just as unity and zero suffice to represent every possible number in the system...
  #+end_quote
...
#+REVEAL: split
#+ATTR_REVEAL: :frag (appear)
- Summer, the South, the sky, the Sun
  #+begin_src
  ---
  ---
  ---
